...
$sql= $db->query("SELECT idprocesos,descripcion FROM procesos WHERE  idprocesos=$id");
...
<form action="../actualizar/registrar-procesos.php" method="POST">
...
<div class="form-group">
<button class="btn btn-success">Actualizar Proceso</button>
</div>
...
<a href="#modal-eliminar-procesos" role="button" 
...
<div class="modal fade" id="modal-eliminar-procesos" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<p>Nota:Tenga en cuenta que, si ya se ha registrado un reporte  con este proceso
no se puede eliminar.</p>
<p>La solución es eliminar el reporte o los reportes con este proceso.</p>

</div>
<div class="modal-footer">
<a href="../eliminar/creacion-de-procesos.php?/=<?php echo $id; ?>"
